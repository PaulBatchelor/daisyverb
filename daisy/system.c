...
{
    /*
     * For now we won't use the board parameter since all
     * three supported boards use the same 16MHz HSE.
     * That said, 2hp Audio BB had a bit different setup, 
     * and actually a more accurate sample rate for audio
     * iirc.
     */
    SystemClock_Config();
    dsy_dma_init(); //
    ...
    /*
     * This will require relocation of DMA buffers, or
     * Cache Maintence. Performance is almost doubled,
     * though.
     */
...
void SystemClock_Config()
{
    ...
    rc = HAL_RCC_ClockConfig(&RCC_ClkInitStruct,
                             FLASH_LATENCY_2)
        != HAL_OK;
    ...
    PeriphClkInitStruct.FmcClockSelection =
    ...
    PeriphClkInitStruct.Sai1ClockSelection =
    ...
    PeriphClkInitStruct.AdcClockSelection =
