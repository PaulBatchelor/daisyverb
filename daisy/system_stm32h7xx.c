...
/* This variable is updated in three ways:
    ...
    Note: If you use this function to configure the system
    clock; then there is no need to call the 2 first
    functions listed above, since SystemCoreClock variable
...
void SystemInit (void)
{
    ...
    /* Reset HSEON, CSSON , CSION,RC48ON, CSIKERON PLL1ON,
       PLL2ON and PLL3ON bits */
    RCC->CR &= 0xEAF6ED7FU;
    ...
    /* Configure the Vector Table location add offset
       address for cortex-M7 */
#ifdef VECT_TAB_SRAM
    /* Vector Table Relocation in Internal D1 AXI-RAM */
